  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-wrap gap-5">
        {[
          { icon: "👨‍⚕️", value: dashData.doctors, label: "Doctors", color: "from-blue-500/20 to-blue-600/5 border-blue-500/20" },
          { icon: "📅", value: dashData.appointments, label: "Appointments", color: "from-purple-500/20 to-purple-600/5 border-purple-500/20" },
          { icon: "🧑‍🤝‍🧑", value: dashData.patients, label: "Patients", color: "from-cyan-500/20 to-cyan-600/5 border-cyan-500/20" },
        ].map((stat, i) => (
          <div
            key={i}
